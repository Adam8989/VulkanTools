...
#if defined PLATFORM_LINUX && defined VK_USE_PLAYFORM_XCB
...
#if defined PLATFORM_LINUX && defined VK_USE_PLAYFORM_WAYLAND
...
#if defined WIN32
class vkDisplayWindows : public vktrace_replay::ReplayDisplayImp {
    friend class vkReplay;
